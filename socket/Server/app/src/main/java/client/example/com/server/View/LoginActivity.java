...
import client.example.com.server.Util.SharedPreferencesUtils;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void login() {
        ...
        if (userName.isEmpty()) {
            ToastUtil.showShort(LoginActivity.this, "Please enter you username");
            return;
        }
        ...
        if (userName.equals("admin") &
                userPwd.equals("123456")) {
            Intent intent_login_to_user = new Intent(LoginActivity.this, ChatOnlineActivity.class);
            startActivity(intent_login_to_user);
        } else {
            ToastUtil.showShort(LoginActivity.this, "This is only a mock login page, only user name \"admin\" and password \"123456\" can log you in ");
        }
